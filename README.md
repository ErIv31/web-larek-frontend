...
Методы:
- set email - устанавливает значение почты пользователя;
- set phone - устанавливает значение телефона пользователя.
...
Методы:
- set basketList - устанавливает количество карточек в корзине;
